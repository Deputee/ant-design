...
import {
  ...
  Table, Chart, Tabs, Segmented, Switch, Tooltip, FloatButton, Drawer
} from 'antd';
import {
      ...
      >
        ...
        <Menu
          ...
          items={[
            ...
            { key: 'messages', icon: <MailOutlined />, label: 'Messages', badge: { count: 5 } },
...
export default ModernDashboard;'use client';
